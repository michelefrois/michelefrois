...
public class Fila    {
   private int maxSize;
   private long[] filaArray;    // Declaro meu Array
   private int comeco;
   private int fim;
   private int nItems;
//--------------------------------------------------------------
   public Fila(int s)          // Método construtor
      {
      maxSize = s;      //Recebendo o tamanho da Fila
      filaArray = new long[maxSize];    //Instancio meu Array, crio minha Fila
      comeco = 0;           // Apontador do começo da Fila
      fim = -1;             // Apontador do final da minha Fila
      nItems = 0;           // Variável que registra a quantidade de elementos da Fila
      }
//--------------------------------------------------------------
